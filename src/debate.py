...
def start_debate(proposition, topic_ix, topic_nr, pool_of_con_debate_agents, n_con_agents, 
                 pool_of_pro_debate_agents, n_pro_agents, url, headers, options_dict, persuadability=0.5):
    debate = {
        "nrounds": 0,
...
def next_debate_round(debate, url, headers, options_dict, persuadability=0.5):
...
def next_debate_round_toxic(debate, url, headers, options_dict, pro_or_con_toxic, persuadability=0.5, toxicity_level=None):
